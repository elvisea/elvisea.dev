...
| Release             | Branch padrão é `main`: `Closes #N` em PR para `develop` só fecha a issue quando o PR de release chega na `main`. Mensagens fora de Conventional Commits são aviso de processo.         |
